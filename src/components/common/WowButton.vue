<template>
  <button
    ...
    class="inline-flex items-center justify-center gap-2 rounded font-semibold text-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0a0e17] disabled:opacity-50 disabled:cursor-not-allowed px-4 py-2 min-h-[44px]"
    :class="variantClass"
    v-bind="$attrs"
  >
    <!-- Loading spinner -->
