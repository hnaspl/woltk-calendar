...
const statusMap = {
  ...
  tentative:  { label: 'Tentative',  cls: 'text-orange-300 bg-orange-500/10 border-orange-500/30', dot: 'bg-orange-400' },
  going:      { label: 'Going',      cls: 'text-green-300 bg-green-500/10 border-green-500/30',  dot: 'bg-green-400' },
  declined:   { label: 'Declined',   cls: 'text-red-300 bg-red-500/10 border-red-500/30',        dot: 'bg-red-400' },
  bench:      { label: 'Bench',      cls: 'text-gray-300 bg-gray-500/10 border-gray-500/30',     dot: 'bg-gray-400' },
  late:       { label: 'Late',       cls: 'text-purple-300 bg-purple-500/10 border-purple-500/30', dot: 'bg-purple-400' }
}
